...
A terminal-based, cross platform maze solver written in Python. The skill features implementations of maze solving algorithms and a collection of CSV mazes.

## What This Does

**Maze Solver** prompts the user to select an input maze and solves it with the selected algorithm all through the CLI. The script outputs a series of time delayed representations of each step of the chosen solution to that maze. The user can also create and solve new CSV mazes.
